...
<!-- <script type="text/javascript" src="<?php echo base_url('assets/css/demo.js'); ?>"></script> -->
<!------ Include the above in your HEAD tag ---------->

<!-- FONTS --><!-- Roboto, Yellowtail, and Montserrat --><link href="https://fonts.googleapis.com/css?family=Montserrat|Roboto:300,400|Yellowtail" rel="stylesheet"><!-- PAGE STUFF -->

<div class="rela-block mycontainer">
	<div class="rela-block profile-card">
		<div class="profile-pic" id="profile_pic"style="background:url('<?= base_url()?>assets/uploads/profile_pics/<?php echo $result[0]['profile_pic'];?>') center no-repeat; background-size: cover;"></div>
...
<div class="row">
	...
	<div class="col-sm-4" align="center">
		  ...
		  <a href="<?= base_url('employer/empProfile');?>"><button class="btn btn-info">Edit Profile</button></a>
	</div>
</div>
