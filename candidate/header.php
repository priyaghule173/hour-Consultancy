				...
				<div class="row">
					<div class="logo col-xs-12">
					     <div class="imageclass">
						    <a href="<?= base_url('candidate/candidateDashboard');?>"><img src="<?= base_url()?>images/logo.png" width="70px" alt="Logo"></a>
                                </div>
...
$profile = $profile[0];
 ?>
								<div class="register-btn">
									<a href="<?= base_url('candidate/candidateDashboard')?>">Welcome <?= $profile['first_name']." ".$profile['last_name'] ?></a>
								</div>
					...
					<div class="container-fluid">
						...
						<div id="navbar-collapse-1" class="navbar-collapse collapse menu-links">
									<ul class="nav navbar-nav">
										<li>
											<a href="<?= base_url('candidate/findJob')?>" style="color: #333; text-transform: uppercase; font-weight: 600;">Search Jobs</a>
										</li>
