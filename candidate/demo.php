...
<div class="rela-block mycontainer">
	<div class="rela-block profile-card">
		<div class="profile-pic" id="profile_pic"style="background:url('<?= base_url()?>assets/uploads/images/<?php echo $profile[0]['profile_photo'];?>') center no-repeat; background-size: cover;"></div>
