...
<div class="container-fluid" style="background-image:url(<?php echo base_url('images/Software-Development1.jpg') ?>);     background-size: cover;">
	<div class="row">
		<div class="col-sm-12" style="height: 150px;  background:#0c0c0ca6;">
			...
			<div class="col-sm-12" style="height: 50px;"><h1 style="text-align: center;color: white;font-size: 40px;">Login</h1></div>
			<div class="col-sm-12" style="height: 50px;"></div>
...
<div class="container-fluid" style="background-image: url(<?php echo base_url('images/admin.jpg') ?>);">
<br>
<div class="login-form">
	...
	<div class="row">
		...
		<div class="col-sm-6">
			<div class="main-div">
    <div class="panel">
    	 <h3 style="color: #0071bb;">Admin Login</h3>
  <!--  <h2>Admin Login</h2> -->
   <p>Please enter your email and password</p>
   </div>
    <form method="post" action="<?=base_url('welcome/check_admin_login')?>" class="">

        <div class="form-group">


            <input type="email"  name="email_id" class="form-control" id="inputEmail" placeholder="Email Address" required>
