...
<div class="container-fluid myoverlay black " style="background:url('<?= base_url()?>images/Career.jpg'); ">
    <h1 style=" " class="myhero">Specialization</h1>
</div>
    ...
    <div class="row">
      ...
      <div class="col-md-9 main-page">
        <div class="careerfy-typo-wrap">
            ...
            <form class="careerfy-employer-dasboard" action="<?=base_url('admin/edit_job_role?jr_id='.$this->input->get('jr_id'))?>" method="post">
                                    <div class="careerfy-employer-box-section">
                                        ...
                                        <ul class="careerfy-row careerfy-employer-profile-form">
                                            <li class="col-sm-6 careerfy-column-6">
                                                ...
                                                <input class="form-control input-lg" type="text" name="job_role" value="<?php echo $result[0]['role']; ?>" placeholder="Enter the unique job role" onblur="if(this.value == '') { this.value ='Old Password'; }" onfocus="if(this.value =='Old Password') { this.value = ''; }" autocomplete="off" required>
                                            </li>
                                            <li class="col-sm-6 careerfy-column-6">
                                              <input type="submit" name="update" class="careerfy-employer-profile-submit" value="Update">
