...
<div class="container-fluid myoverlay black " style="background:url('<?= base_url()?>images/Career.jpg'); ">
    <h1 style=" " class="myhero">Gold Packages</h1>
</div>
        ...
        <div class="careerfy-typo-wrap">
            ...
            <div class="careerfy-employer-box-section">
              ...
              <div class="tab-content">
                ...
                <div id="TAB_1" class="tab-pane fade in active">
                  <form method="post" action="<?=base_url('admin/pendingGoldPackEmp')?>">
                    <!-- <div class="row"> -->

                    <div class="careerfy-employer-box-section">
                      <div class="careerfy-profile-title">
                        <h2 style="font-size: 18px;">Update Amount</h2>
                      </div>
                      <ul class="careerfy-row careerfy-employer-profile-form">
                        <li class="careerfy-column-6">
                          <label style="font-size: 13px;">Enter Amount*</label>
                        ...
                        <li class="careerfy-column-6">
                          <input type="submit" name="paid_gold" value="Paid" class="careerfy-employer-profile-submit" style="font-size: 13px;">
                        </li>
                      </ul>
                    ...
                    <div class="careerfy-profile-title">
                      <h2 style="font-size: 18px;">Pending Employers Gold Package Approval</h2>
                    </div>
          ...
          <div id="TAB_2" class="tab-pane fade">
                                   ...
                                   <div class="col-md-12 bg-white padding-2"> -->
                                    <div class="careerfy-profile-title">
                                      <h2 style="font-size: 18px;">Active Employers Gold Package List</h2>
                                    </div>
                                    <div class="row margin-top-20">
                                      <div class="col-md-12">
                                        <div class="box-body table-responsive no-padding">
                                    ...
                                    <div id="TAB_3" class="tab-pane fade">
                                      ...
                                      <div class="col-md-12 bg-white padding-2"> -->
                                          ...
                                          <div class="row">
                                            <div class="col-md-12">
                                              <form class="careerfy-employer-dasboard" action="<?=base_url('admin/custom_gold_emp_pack')?>" method="post">
                                                <div class="careerfy-employer-box-section">
                                                  <div class="careerfy-profile-title">
                                                    <h2 style="font-size: 18px;">Active Custom Employers Gold Package</h2>
                                                  </div>
                                                  <ul class="careerfy-row careerfy-employer-profile-form">
                                                    <?php
                                                    ...
                                                    ->where('Package_type!=','Platinum')->where('active','1')->where('employer.e_id NOT IN (select employer_packages.e_id from employer_packages where package_name ="Gold")')->order_by('first_name','ASC')->get()->result_array();
                                                    ?>
                                                   ...
                                                   <li class="careerfy-column-6 col-sm-6">
                                                    ...
                                                    <input class="form-control input-lg" value="Gold" readonly="readonly" type="text"  onblur="if(this.value == '') { this.value ='Old Password'; }" onfocus="if(this.value =='Old Password') { this.value = ''; }" autocomplete="off" required>
                                                  </li>
                                                  <li class="careerfy-column-6 col-sm-6">
                                                ...
                                                <input type="submit" name="Activate" value="Activate" class="careerfy-employer-profile-submit" style="font-size: 13px;">
