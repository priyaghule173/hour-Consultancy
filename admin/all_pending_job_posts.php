...
?>
     <li class="active">
      <a href="<?= base_url('admin/featuredJob');?>">
       ...
       Featured Job Section <span style="background: #a9d86e;border-radius: 10px;padding: 5px;"><?= count($total_fj)?></span>
     </a>
   </li>
        ...
        <div class="careerfy-typo-wrap">
          <div class="careerfy-employer-box-section">
            ...
            <div class="careerfy-profile-title">
                <h2>Pending Employers Jobs Posts Requests</h2>
                <style type="text/css">
  .pulse {
  display: block;
  width: 55px;
      ...
      box-shadow: 0 0 0 0 rgba(204,169,44, 0);
            ...
            <div class="row">
                                            <div class="col-md-12">
                                              ...
                                              <form method="post" action="<?= base_url('admin/all_pending_job_posts')?>">
                                                <input type="submit" name="Job_Approved" style="margin-right:10px; padding: 10px 10px; margin-bottom: 5px;" class="careerfy-employer-profile-submit" value="Approve">&nbsp;&nbsp;
                                                <input type="submit" name="Job_Rejected" style="margin-right:10px; padding: 10px 10px; margin-bottom: 5px;"  class="careerfy-employer-profile-submit" value="Reject">
                                                         ...
                                                         <input type="checkbox" class="select-item checkbox" name="select_item[]" value="<?=$row['j_id']?>" title="<?=$row['j_id']?>"/>
                                                           ...
                                                           <td>
                                                            <?php
                                                              ...
                                                              {
                                                            ?>
                                                            <span class="pulse"><?= $row['Package_type']?></span>
                                                            <?php
                                                              }else{
