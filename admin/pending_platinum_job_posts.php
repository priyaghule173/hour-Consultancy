...
<div class="container-fluid myoverlay black " style="background:url('<?= base_url()?>images/Career.jpg'); ">
    <h1 style=" " class="myhero">Pending Platinum Job Posts</h1>
</div>
            ...
            <div class="row">
              <div class="col-md-12">
                  <div class="box-body table-responsive no-padding">
                    <form method="post" action="<?= base_url('admin/pending_platinum_job_posts')?>">
                                                  <input type="submit" style="margin-right:10px; margin-bottom:5px; padding: 10px 10px;" class="careerfy-employer-profile-submit" name="Job_Approved" value="Approve">
                                                  <input type="submit" style="margin-right:10px; margin-bottom:5px; padding: 10px 10px;" class="careerfy-employer-profile-submit" name="Job_Rejected" value="Reject">
