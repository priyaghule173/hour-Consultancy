...
<div class="container-fluid myoverlay black " style="background:url('<?= base_url()?>images/Career.jpg'); ">
    <h1 style=" " class="myhero">Pending Gold Job Posts</h1>
</div>
             ...
             <div class="careerfy-profile-title">
                                          ...
                                          <div class="row margin-top-20">
                                            <div class="col-md-12">
                                              ...
                                              <form method="post" action="<?= base_url('admin/pending_gold_job_posts')?>">
                                                <input type="submit" style="margin-right:10px; margin-bottom:5px; padding: 10px 10px;"  name="Job_Approved" value="Approve">
                                                <input type="submit" style="margin-right:10px; margin-bottom:5px; padding: 10px 10px;"  name="Job_Rejected" value="Reject">
