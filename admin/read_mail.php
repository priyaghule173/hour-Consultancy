  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-md-9 main-page">
        <div class="careerfy-typo-wrap">
              <form class="careerfy-employer-dasboard" action="<?= base_url('employer/create_mail');?>" method="post">
                                    <div class="careerfy-employer-box-section">
                                        <div class="careerfy-profile-title"><h2>View New Message</h2></div>
                                        <ul class="careerfy-row careerfy-employer-profile-form">
                                          ...
                                          $mails = $this->db->select('*')->from('mailbox')->where('mailbox_id',$this->input->get('id_mail'))->join('employer','mailbox.from_userid=employer.e_id')->get()->result_array();
            
                                          foreach($mails as $mail){

                                          ?>
                                            <li class="col-sm-12 careerfy-column-12">
                                                <label>From *</label>
                                                <!-- <div class="careerfy-profile-select"> -->
                                                <input readonly class="form-control" value="<?= $mail['first_name']." ".$mail['last_name']." ".$mail['middle_name']."  <".$mail['email_id'].">" ?>">  
                                            </li><br>
                                            <li class="col-sm-12 careerfy-column-12">
                                                <label>Subject *</label>
                                                <input readonly class="form-control input-lg"  class="form-control" value="<?= $mail['subject'];?>" name="subject" placeholder="Subject:"  onblur="if(this.value == '') { this.value ='Jody Wisternoff'; }" onfocus="if(this.value =='Jody Wisternoff') { this.value = ''; }" type="text" required="">
                                            </li>
                                            <li class="col-sm-12 careerfy-column-12">
                                              <label>Message*</label>
                                            <textarea readonly class="form-control input-lg" id="description" name="description" value="<?= $mail['message'];?>"><?php echo $mail['message'];?></textarea>
                                        </li>
                                        <?php
                                      }
                                        ?>
...
<!--                                    <a href="<?= base_url('admin/mailbox');?>" style="padding:8px;" class="btn btn-default btn-lg"><i class="fa fa-times"></i> Discard</a>
-->                                </form>
        </div>
      </div>
